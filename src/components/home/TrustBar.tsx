  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 24 24" className="w-5 h-5" fill="#005A78">
        ...
        <text x="8" y="16" fontSize="10" fontWeight="bold" fill="#005A78">
          A+
        </text>
      </svg>
    ),
...
export default function TrustBar() {
  return (
    <motion.section
      ...
      viewport={{ once: true }}
      variants={fadeIn}
      className="py-6 md:py-8 bg-white border-b border-neutral-100"
    >
      <div className="container-custom">
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8 md:gap-14">
          <p className="text-neutral-400 text-xs font-semibold uppercase tracking-[0.15em]">
            Official Partner
          </p>
